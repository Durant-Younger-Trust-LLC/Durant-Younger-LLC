...
class BankAccountResourceIT {
    ...
    public static BankAccount createEntity(EntityManager em) {
        BankAccount bankAccount = new BankAccount().accountName(DEFAULT_ACCOUNT_NAME).balance(DEFAULT_BALANCE);
        return bankAccount;
    }
    ...
    public static BankAccount createUpdatedEntity(EntityManager em) {
        BankAccount bankAccount = new BankAccount().accountName(UPDATED_ACCOUNT_NAME).balance(UPDATED_BALANCE);
        return bankAccount;
    }
    ...
    void putExistingBankAccount() throws Exception {
        ...
        updatedBankAccount.accountName(UPDATED_ACCOUNT_NAME).balance(UPDATED_BALANCE);
    ...
    void partialUpdateBankAccountWithPatch() throws Exception {
        ...
        partialUpdatedBankAccount.accountName(UPDATED_ACCOUNT_NAME).balance(UPDATED_BALANCE);
