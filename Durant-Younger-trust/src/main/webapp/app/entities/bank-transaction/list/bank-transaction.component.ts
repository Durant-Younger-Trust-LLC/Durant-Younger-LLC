...
import { EntityArrayResponseType, BankTransactionService } from '../service/bank-transaction.service';
...
export class BankTransactionComponent implements OnInit {
  ...
  trackId = (_index: number, item: IBankTransaction): number => this.bankTransactionService.getBankTransactionIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.bankTransactions = this.refineData(dataFromBody);
  }

  protected refineData(data: IBankTransaction[]): IBankTransaction[] {
